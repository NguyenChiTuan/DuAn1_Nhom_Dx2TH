<%-- 
    Document   : QuanLyBinhLuan
    Created on : Dec 8, 2016, 2:45:30 PM
    Author     : TAO-PC
--%>
    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li   class="active" ><a href="QuanLyBinhLuan.jsp"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg> Quản Lý Bình Luận</a></li>
