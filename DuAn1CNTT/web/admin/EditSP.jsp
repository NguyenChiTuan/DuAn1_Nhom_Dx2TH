        ...
        <!-- Modal -->
                    <%
                        if (request.getParameter("idsanpham") != null) {
                            ...
                            xp = spsv.GetSanPhamTheoId(Integer.parseInt(request.getParameter("idsanpham")));
                    %>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div id="boxshadow" class="jumbotron">
                        <form class="form-horizontal form-edit-user text-center" action="../EditSPServlet" method="post" enctype="multipart/form-data">
                            <h3>Sửa Sản Phẩm</h3>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="gia" value="<%= xp.getGia()%>" class="form-control" required="" id="gia">
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label col-md-2" for="giakm">Giá Khuyễn Mãi:</label>
                                <div class="col-sm-10">
                                    <input type="number" name="giakm" value="<%= xp.getGiaKm()%>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="mota" value="<%= xp.getMoTa()%>" class="form-control"  id="mota">
                                </div>
                            </div>
